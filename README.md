...
[![Email](https://img.shields.io/badge/Email-you%40email.com-3fb950?style=flat-square&logo=gmail&logoColor=white)](mailto:you@email.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0a66c2?style=flat-square&logo=linkedin)](https://linkedin.com/in/yourname)
[![Blog](https://img.shields.io/badge/Blog-Articles-f0883e?style=flat-square&logo=hashnode&logoColor=white)](https://yourblog.dev)
[![Website](https://img.shields.io/badge/Website-yoursite.dev-58a6ff?style=flat-square&logo=vercel&logoColor=white)](https://yourwebsite.dev)

![Profile Views](https://komarev.com/ghpvc/?username=yourusername&color=3fb950&style=flat-square&label=Profile+Views)
...
API & Performance     ████████████        Postman · k6 · REST / GraphQL
...
- 📘 [Why Most Test Automation Fails (And How to Fix It)](https://yourblog.dev/post1) — *Feb 2026*
- 📗 [Playwright vs Cypress in 2026: A Real Comparison](https://yourblog.dev/post2) — *Jan 2026*
- 📙 [Building a Zero-Flake Test Suite from Scratch](https://yourblog.dev/post3) — *Dec 2025*
- 📕 [CI Pipeline Design for QA Engineers](https://yourblog.dev/post4) — *Nov 2025*

<!-- BLOG-POST-LIST:END -->


> 🗞 [Read all articles →](https://yourblog.dev)
...
|I can help with                                    |How                                         |
|---------------------------------------------------|--------------------------------------------|
|🧱 Building a test automation framework from scratch|[Email me](mailto:you@email.com)            |
|🔍 Auditing your existing QA setup                  |[Book a call](https://cal.com/yourname)     |
|🚀 Integrating tests into your CI/CD pipeline       |[LinkedIn](https://linkedin.com/in/yourname)|
